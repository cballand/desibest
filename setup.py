...
#
setup_keywords['name'] = 'desibest'
setup_keywords['description'] = 'DESI package for zbest files analysis'
setup_keywords['author'] = 'C. Balland'
setup_keywords['author_email'] = 'balland@lpnhe.in2p3.fr'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/cballand/desibest'
#
